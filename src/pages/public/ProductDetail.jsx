...
// Helper function untuk memformat URL gambar
...
export default function ProductDetail() {
  ...
  // State untuk interaksi user
  const [selectedVariant, setSelectedVariant] = useState(null);
  const [quantity, setQuantity] = useState(1);

  // STATE: Untuk fitur Zoom Gambar & Gambar Aktif
  ...
  return (
    <div className="min-h-screen bg-white py-12 px-4 md:px-8 max-w-7xl mx-auto">
      ...
      {/* LAPISAN ZOOM GAMBAR (MODAL FULLSCREEN) */}
      ...
      <div className="mb-8 font-black uppercase tracking-widest text-xs flex gap-2 text-gray-400">
        ...
        <span>/</span>
        <Link to="/products" className="hover:text-black transition-colors">Koleksi</Link>
        <span>/</span>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-16">
        ...
        <div className="flex flex-col gap-4">
          ...
          {/* GAMBAR UTAMA */}
          <div
            className="border-4 border-black shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] bg-gray-100 aspect-[3/4] md:aspect-auto md:h-[90vh] relative overflow-hidden group cursor-zoom-in"
