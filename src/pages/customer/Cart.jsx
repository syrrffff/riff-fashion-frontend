...
export default function Cart() {
  ...
  const updateQuantity = async (itemId, currentQuantity, change) => {
    ...
    // Jangan izinkan jumlah kurang dari 1
        ...
        <div className="flex flex-col lg:flex-row gap-10">
                ...
                <div key={item.item_id} className="py-6 grid grid-cols-1 md:grid-cols-12 gap-4 items-center">
                  ...
                  <div className="col-span-12 md:col-span-5 flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      {/* Tombol Hapus (Mobile View & Desktop) */}
                      <button
                        onClick={() => removeItem(item.item_id)}
                        className="text-xs text-red-500 hover:text-red-700 font-medium uppercase tracking-wider mt-2 flex items-center"
                      >
                  ...
                  <div className="col-span-6 md:col-span-3 flex justify-start md:justify-center items-center mt-4 md:mt-0">
                    <div className="flex items-center border border-gray-300 rounded-none">
                      <button
                        ...
                        className="px-3 py-1 text-gray-600 hover:bg-gray-100 transition focus:outline-none"
                  ...
                  {/* Subtotal */}
                  <div className="col-span-6 md:col-span-2 text-right font-bold text-gray-900 mt-4 md:mt-0">
          ...
          <div className="lg:w-1/3">
            <div className="bg-gray-50 p-8 border border-gray-100">
              <h2 className="text-lg font-bold text-gray-900 uppercase tracking-wide mb-6">Ringkasan Pesanan</h2>

              <div className="flex justify-between text-gray-600 mb-4 text-sm">
                <span>Total Item</span>
                <span className="font-medium">{cartItems.reduce((acc, item) => acc + item.quantity, 0)} Pcs</span>
              </div>

              <div className="border-t border-gray-200 my-4 pt-4 flex justify-between items-center">
                <span className="text-base font-bold text-gray-900 uppercase">Total Harga</span>
                <span className="text-xl font-black text-gray-900">
                  Rp {new Intl.NumberFormat('id-ID').format(calculateTotal())}
                </span>
              </div>

              <Link to="/checkout" className="block text-center w-full mt-6 bg-black text-white py-4 text-sm font-bold uppercase tracking-widest hover:bg-gray-800 transition">
                Checkout
              </Link>
            </div>
          </div>
